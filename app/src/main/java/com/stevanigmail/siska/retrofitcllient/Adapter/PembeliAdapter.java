package com.stevanigmail.siska.retrofitcllient.Adapter;
...
import com.stevanigmail.siska.retrofitcllient.GetPembeliActivity;
import com.stevanigmail.siska.retrofitcllient.Model.Pembeli;
import com.stevanigmail.siska.retrofitcllient.PutDelPembeliActivity;
import com.stevanigmail.siska.retrofitcllient.R;
import com.stevanigmail.siska.retrofitcllient.Rest.ApiClient;
...
//Picasso.with(holder.itemView.getContext()).load(ApiClient.BASE_URL+listPembeli.get(position).getPhotoId()).into(holder.mPhotoid);
            Glide.with(holder.itemView.getContext()).load(ApiClient.BASE_URL+listPembeli.get(position).getPhotoId()).into(holder.mPhotoid);
        }else{
